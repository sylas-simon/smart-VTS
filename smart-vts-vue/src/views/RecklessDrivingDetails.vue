<template>
  <div class="violation-details">
    <div class="header">
      <h1>Reckless Driving Details</h1>
      ...
      <div class="section">
        ...
        <div class="info-grid">
          ...
          <div class="info-item">
            ...
            <span class="severity" :class="violation.severity">{{ violation.severity }}</span>
          </div>
          <div class="info-item">
        ...
        <div class="behavior-details">
          ...
          <ul class="behavior-list">
            <li v-for="(behavior, index) in violation.behaviors" :key="index">
...
export default {
  ...
  setup() {
    ...
    const violation = ref({
      ...
      violationType: 'Aggressive Driving',
      severity: 'high',
      startTime: new Date(),
      duration: 900000, // 15 minutes in milliseconds
      location: 'Highway B2, Kilometer 30',
      roadName: 'Highway B2',
    ...
    onMounted(() => {
      ...
      console.log('Fetching reckless driving data for ID:', violationId)
